...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	var in models.CreateRecordRequest
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	recordID, err := utils.PathID(r, "recordID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.Get(r.Context(), recordID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	var in models.UpdateRecordRequest
	if err := utils.DecodeJSON(w, r, &in); err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.Update(r.Context(), recordID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Delete(r.Context(), recordID, actor(r).ID); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) SetFieldValue(w http.ResponseWriter, r *http.Request) {
	recordID, err := utils.PathID(r, "recordID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	...
	var in models.SetFieldValueRequest
	if err := utils.DecodeJSON(w, r, &in); err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.SetFieldValue(r.Context(), recordID, fieldID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) ListRevisions(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.ListRevisions(r.Context(), recordID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
