...
func (h *Handler) ListByProject(w http.ResponseWriter, r *http.Request) {
	projectID, err := utils.PathID(r, "projectID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.ListByProject(r.Context(), projectID, actor(r).ID)
	if err != nil {
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Create(r.Context(), projectID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	taskID, err := utils.PathID(r, "taskID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.Get(r.Context(), taskID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Update(r.Context(), taskID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Delete(r.Context(), taskID, actor(r).ID); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Move(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Move(r.Context(), taskID, actor(r).ID, in); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
