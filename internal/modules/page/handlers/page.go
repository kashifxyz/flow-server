...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Get(r.Context(), pageID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Update(r.Context(), pageID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Delete(r.Context(), pageID, actor(r).ID); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Duplicate(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Duplicate(r.Context(), pageID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Move(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Move(r.Context(), pageID, actor(r).ID, in); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
	w.WriteHeader(http.StatusNoContent)
