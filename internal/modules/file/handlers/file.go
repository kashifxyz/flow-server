...
func (h *Handler) CreateUpload(w http.ResponseWriter, r *http.Request) {
	...
	var in models.CreateUploadRequest
	if err := utils.DecodeJSON(w, r, &in); err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.CreateUpload(r.Context(), wsID, actor(r).ID, in)
	if err != nil {
...
func (h *Handler) CompleteUpload(w http.ResponseWriter, r *http.Request) {
	uploadID, err := utils.PathID(r, "uploadID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	var in models.CompleteUploadRequest
	if err := utils.DecodeJSON(w, r, &in); err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.CompleteUpload(r.Context(), uploadID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	fileID, err := utils.PathID(r, "fileID")
	if err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.Get(r.Context(), fileID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	var in models.UpdateFileRequest
	if err := utils.DecodeJSON(w, r, &in); err != nil {
		httperr.Write(w, h.Log, httperr.ErrInvalid)
		return
	}
	out, err := h.Svc.Update(r.Context(), fileID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Delete(r.Context(), fileID, actor(r).ID); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Download(w http.ResponseWriter, r *http.Request) {
	...
	url, err := h.Svc.DownloadURL(r.Context(), fileID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
