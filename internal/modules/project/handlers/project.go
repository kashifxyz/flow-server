...
func (h *Handler) Get(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Get(r.Context(), projectID, actor(r).ID)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	out, err := h.Svc.Update(r.Context(), projectID, actor(r).ID, in)
	if err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
...
func (h *Handler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.Svc.Delete(r.Context(), projectID, actor(r).ID); err != nil {
		httperr.Write(w, h.Log, err)
		return
	}
